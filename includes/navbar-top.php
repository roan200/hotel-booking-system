<nav class="sb-topnav navbar navbar-expand navbar-dark "style = "background-color: #003C4D">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3 text-white" href="#">Hotel Booking System</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item text-dark" href="#">Activity Log</a></li>
